...
sys.path.append('../../../../')
from trainers import trainer_snapshot_n, bifrn_train
...
pm = trainer_snapshot_n.Path_Manager(fewshot_path=fewshot_path,args=args)
...
tm = trainer_snapshot_n.Train_Manager(args,path_manager=pm,train_func=train_func)
